...
const ZONEPHONEGATE_DESTINATION_URL = 'https://apps.shopify.com/zonephonegate';
const GA_MEASUREMENT_ID = 'G-282VT6K98Y';

// This GET handler creates `/go/zonephonegateListing` as a layout-free redirect route.
export async function GET(request) {
          ...
          events: [
            {
              ...
              params: {
                redirect_key: 'zonephonegateListing',
                from_path: url.pathname,
                destination_url: ZONEPHONEGATE_DESTINATION_URL,
              },
            },
          ],
        }),
  ...
  return NextResponse.redirect(ZONEPHONEGATE_DESTINATION_URL, 307);
}
