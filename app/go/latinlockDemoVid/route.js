...
const LATINLOCK_DEMO_VIDEO_DESTINATION_URL = 'https://youtu.be/8UdnqKvOZ8o';
const GA_MEASUREMENT_ID = 'G-282VT6K98Y';

// This GET handler creates `/go/latinlockDemoVid` as a layout-free redirect route.
export async function GET(request) {
          ...
          events: [
            {
              ...
              params: {
                redirect_key: 'latinlockDemoVid',
                from_path: url.pathname,
                destination_url: LATINLOCK_DEMO_VIDEO_DESTINATION_URL,
              },
            },
          ],
        }),
  ...
  return NextResponse.redirect(LATINLOCK_DEMO_VIDEO_DESTINATION_URL, 307);
}